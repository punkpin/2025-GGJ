...
public class WhiskerMoveController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.GetKey(KeyCode.LeftArrow)) // J 键向左
        {
            moveX = -5f;
        }
        else if (Input.GetKey(KeyCode.RightArrow)) // L 键向右
        {
            moveX = 5f;
        }

        if (Input.GetKey(KeyCode.UpArrow)) // I 键向上
        {
            moveY = 5f;
        }
        else if (Input.GetKey(KeyCode.DownArrow)) // K 键向下
        {
            moveY = -5f;
        }
